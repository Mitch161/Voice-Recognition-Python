...
SOURCE_URL = 'https://storage.cloud.google.com/download.tensorflow.org/data/'
DATA_DIR = 'data/'
pcm_path = "/home/mitchell/Documents/speech_data_files/commands/needed/"
...
class Source:  # labels
  ...
  DIGIT_WAVES = 'data_speech_commands_v0.02.tar.gz'
...
def maybe_download(file, work_directory):
  ...
  if os.path.exists(filepath):
    ...
    os.system('tar -xvzf %s -C %s' % ( filepath, work_directory))
    print('Data ready!')
